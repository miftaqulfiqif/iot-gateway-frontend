...
const Patients = () => {
  ...
  //PatientMeasurement
  const buttonActionHistoryMeasurement = (id: number) => {
  ...
  //FILTER
  const handlePatientMeasurementFiltered = (reset?: boolean) => {
    setCurrentPage(1);
    ...
    <MainLayout title="Patients" state="Patients">
      <div className="sticky top-0 z-50 bg-[#ededf9] mb-2">
        <div className="flex flex-col w-full gap-4">
          ...
          <div className="w-full bg-white rounded-2xl shadow-[0px_4px_4px_rgba(0,0,0,0.3)] "></div>
        </div>
      </div>
      <div className="flex flex-col gap-4 pb-20 px-2 h-full">
