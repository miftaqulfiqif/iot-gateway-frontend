...
export const SelectPatientRoomModal = ({
  isActive,
  setInactive,
  closeAllModals,
  patientSelected,
  ...
  return (
    <div
      className={`fixed right-0 top-0 w-full h-full bg-transparent bg-opacity-50 z-60 transition-opacity duration-300  ${
        ...
        >
          <div className="flex flex-col gap-2">
            <div className="flex flex-row items-center justify-between">
              <p className="font-bold text-xl">Select Room</p>
            ...
            {/* LIST ROOMS */}
            <p className="mt-2 font-semibold">Rooms available</p>
