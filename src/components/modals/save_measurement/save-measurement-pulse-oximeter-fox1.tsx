...
type Props = {
  ...
  device: any;
  room: String;
  result?: PulseOximeterFox1Model;
};

export const SaveMeasurementPulseOximeterFox1 = ({
  isActive,
  setInactive,
  patient,
  device,
  ...
  const handleSave = async (data: any) => {
    try {
      const response = await axios.post(
        `${apiUrl}/api/measurement-histories-pulse-oximeter-fox1`,
        data,
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-100 p-4 rounded-lg text-center">
                <p className="text-sm text-gray-500">Sp02</p>
